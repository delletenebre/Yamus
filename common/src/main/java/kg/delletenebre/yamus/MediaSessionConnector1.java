 ...
 *       PlaybackStateCompat#ACTION_PLAY_*}) can be handled by a {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.PlaybackPreparer} passed to
 *       {@link #setPlaybackPreparer(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.PlaybackPreparer)}.
 *   <li>Custom actions can be handled by passing one or more {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider}s to
 *       {@link #setCustomActionProviders(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider...)}.
 *   <li>To enable a media queue and navigation within it, you can set a {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueNavigator} by
 *       calling {@link #setQueueNavigator(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueNavigator)}. Use of {@link TimelineQueueNavigator}
 *       is recommended for most use cases.
 *   <li>To enable editing of the media queue, you can set a {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueEditor} by calling {@link
 *       #setQueueEditor(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueEditor)}.
 *   <li>A {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaButtonEventHandler} can be set by calling {@link
 *       #setMediaButtonEventHandler(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaButtonEventHandler)}. By default media button events are
 ...
 *   <li>A {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaMetadataProvider} can be set by calling {@link
 *       #setMediaMetadataProvider(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaMetadataProvider)}. By default the {@link
 *       com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.DefaultMediaMetadataProvider} is used.
 * </ul>
 */
public final class MediaSessionConnector1 {
    ...
    @com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.PlaybackActions
    ...
    public interface PlaybackPreparer extends com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver {
     ...
     */
    public interface QueueNavigator extends com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver {
    ...
    public interface QueueEditor extends com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver {
    ...
    public interface RatingCallback extends com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver {
    ...
    private final ArrayList<com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver> commandReceivers;
    private final ArrayList<com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver> customCommandReceivers;

    private ControlDispatcher controlDispatcher;
    private com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider[] customActionProviders;
    private Map<String, com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider> customActionMap;
    @Nullable private com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaMetadataProvider mediaMetadataProvider;
    @Nullable private Player player;
    @Nullable private ErrorMessageProvider<? super ExoPlaybackException> errorMessageProvider;
    @Nullable private Pair<Integer, CharSequence> customError;
    @Nullable private Bundle customErrorExtras;
    @Nullable private com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.PlaybackPreparer playbackPreparer;
    @Nullable private com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueNavigator queueNavigator;
    @Nullable private com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueEditor queueEditor;
    @Nullable private com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.RatingCallback ratingCallback;
    @Nullable private com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaButtonEventHandler mediaButtonEventHandler;
     ...
     */
    public MediaSessionConnector1(MediaSessionCompat mediaSession) {
        ...
        customActionProviders = new com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider[0];
        customActionMap = Collections.emptyMap();
        mediaMetadataProvider =
                new com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.DefaultMediaMetadataProvider(
    ...
    /**
     * Sets the {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.PlaybackPreparer}.
     *
     * @param playbackPreparer The {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.PlaybackPreparer}.
     */
    public void setPlaybackPreparer(@Nullable com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.PlaybackPreparer playbackPreparer) {
    ...
    /**
     * Sets the {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaButtonEventHandler}. Pass {@code null} if the media button event should be
     * handled by {@link MediaSessionCompat.Callback#onMediaButtonEvent(Intent)}.
     *
     * @param mediaButtonEventHandler The {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaButtonEventHandler}, or null to let the event be
     *     handled by {@link MediaSessionCompat.Callback#onMediaButtonEvent(Intent)}.
     */
    public void setMediaButtonEventHandler(
            @Nullable com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaButtonEventHandler mediaButtonEventHandler) {
     ...
     */
    public void setEnabledPlaybackActions(@com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.PlaybackActions long enabledPlaybackActions) {
    ...
    /**
     * Sets the {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueNavigator} to handle queue navigation actions {@code ACTION_SKIP_TO_NEXT},
     * {@code ACTION_SKIP_TO_PREVIOUS} and {@code ACTION_SKIP_TO_QUEUE_ITEM}.
     *
     * @param queueNavigator The queue navigator.
     */
    public void setQueueNavigator(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueNavigator queueNavigator) {
    ...
    /**
     * Sets the {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueEditor} to handle queue edits sent by the media controller.
     *
     * @param queueEditor The queue editor.
     */
    public void setQueueEditor(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueEditor queueEditor) {
    ...
    /**
     * Sets the {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.RatingCallback} to handle user ratings.
     *
     * @param ratingCallback The rating callback.
     */
    public void setRatingCallback(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.RatingCallback ratingCallback) {
    ...
    /**
     * Sets custom action providers. The order of the {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider}s determines the
     ...
     *     action providers.
     */
    public void setCustomActionProviders(@Nullable com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider... customActionProviders) {
        this.customActionProviders =
                customActionProviders == null ? new com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider[0] : customActionProviders;
        invalidateMediaSessionPlaybackState();
    }
     ...
     *     metadata should be published.
     */
    public void setMediaMetadataProvider(@Nullable com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaMetadataProvider mediaMetadataProvider) {
     ...
     * {@link com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaMetadataProvider#getMetadata(Player)}.
     */
     ...
     * com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider} changed and the playback state needs to be updated immediately.
     */
    public final void invalidateMediaSessionPlaybackState() {
        ...
        Map<String, com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider> currentActions = new HashMap<>();
        for (com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CustomActionProvider customActionProvider : customActionProviders) {
     ...
     * com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueNavigator#onTimelineChanged(Player)}.
     *
     ...
     */
    public void registerCustomCommandReceiver(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver commandReceiver) {
     ...
     */
    public void unregisterCustomCommandReceiver(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver commandReceiver) {
        customCommandReceivers.remove(commandReceiver);
    }

    private void registerCommandReceiver(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver commandReceiver) {
        if (!commandReceivers.contains(commandReceiver)) {
            commandReceivers.add(commandReceiver);
        }
    }

    private void unregisterCommandReceiver(com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.CommandReceiver commandReceiver) {
    ...
    private long buildPlaybackActions(Player player) {
        ...
        if (queueNavigator != null) {
            actions |=
                    (com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.QueueNavigator.ACTIONS & queueNavigator.getSupportedQueueNavigatorActions(player));
        }
     ...
     */
    public static final class DefaultMediaMetadataProvider implements com.google.android.exoplayer2.ext.mediasession.MediaSessionConnector.MediaMetadataProvider {
